<x-layouts.app title="Dashboard">
    ...
    <div class="space-y-6">
        ...
        @if (isset($tabunganWajibBelumLunas) && $tabunganWajibBelumLunas > 0)
            <div class="alert-warning">
                ...
                <p>
                    <strong>{{ $tabunganWajibBelumLunas }} siswa</strong> belum membayarkan Tabungan Wajib bulan
                    {{ now()->locale('id')->isoFormat('MMMM YYYY') }}.
                </p>
            </div>
        @endif
                        ...
                        <form id="form-penerimaan" novalidate method="POST" action="{{ route('penerimaan.store') }}">
                            ...
                            <div class="card-body space-y-5">
                                ...
                                <div id="section-tabungan_wajib" class="space-y-3 hidden">
                                    <div id="dash-list-items-tabungan-wajib" class="space-y-2">
    ...
    <script>
        ...
        function renderDashboardDetailSiswa(data) {
            ...
            const twListEl = document.getElementById('dash-list-items-tabungan-wajib');
            if (twListEl) {
